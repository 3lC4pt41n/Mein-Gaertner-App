  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.hero}>
        ...
        <Text style={styles.subtitle}>{t('beta.subtitle')}</Text>
      </View>
      ...
      <View style={[styles.card, styles.giftCard]}>
        ...
        <Text style={styles.cardText}>{t('beta.giftDesc')}</Text>
      </View>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.cardText}>{t('beta.reloadDesc')}</Text>
      </View>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.cardText}>{t('beta.feedbackDesc')}</Text>
      </View>
...
const styles = StyleSheet.create({
  ...
  giftCard: { borderWidth: 2, borderColor: colors.warning },
  cardHeader: {
    flexDirection: 'row',
    alignItems: 'center',
    marginBottom: 10,
