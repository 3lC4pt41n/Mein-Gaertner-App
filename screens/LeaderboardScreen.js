                ...
                <View style={styles.statsCard}>
                  ...
                  <DSButton
                    ...
                    onPress={async () => {
                      ...
                      try {
                        await Share.share({
                          message: `🌱 ${scoreName}: ${scoreVal} ${t('common.pointsFull')} | ${t('leaderboard.streakValue', { days: myStats.streak })} Streak | ${myStats.totalDiscoveries} ${t('leaderboard.discovered')} — FloraPilot`,
                        });
                      } catch (error) {
                        const cancelled =
